      ...
      <div className="flex flex-col gap-1 w-72 shadow-2xl rounded-xl p-5 border border-third">
        ...
        <ul>
          {categories.map((item, index) => (
            <li
              key={index}
              className="w-full p-2 bg-first/90 rounded shadow mb-2 transition-all   text-third hover:bg-first hover:shadow-lg cursor-pointer"
            >
